...
from Core.Methods.inline_code import inline_code_obfuscate
from Core.Methods.control_flow import control_flow_obfuscate
from Core.Methods.control_flow_flatten import control_flow_flatten_obfuscate  # Import the new obfuscator
from Core.Methods.function_mirroring import function_mirroring_obfuscate
from Core.Methods.number_to_hex import obfuscate_numbers_to_hex
from Core.Methods.obfuscate_constants import obfuscate_constants
from Core.Methods.obfuscate_identifiers import obfuscate_identifiers
from Core.Methods.opaque_predicates import insert_opaque_predicates
from Core.Methods.dummy_variable_inserter import insert_dummy_variables
